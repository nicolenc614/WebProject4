<?php
  echo "<nav class=\"navbar navbar-toggleable-md navbar-light bg-faded\" style=\"background: red\">";
  ...
  echo "</button>";
  echo "<a class=\"navbar-brand\" style=\"color:black\" href=\"#\"> Supporting You Through Your Travel Journey </a>";
